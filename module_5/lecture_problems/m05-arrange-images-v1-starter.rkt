...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname m05-arrange-images-v1-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
(require 2htdp/image)
