...
(define (can-vote? status)
  (cond [(string=? status "minor") false]
        [(string=? status "adult") true]
        [else false]))


; I had to look at the solution just for interp because there
; was no information saying 0 and 1 were not valid
