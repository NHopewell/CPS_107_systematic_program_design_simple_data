...
(define blue_square (square 20 "solid" "blue"))
(define yellow_square (square 20 "solid" "yellow"))

(above (beside blue_square yellow_square)
       (beside yellow_square blue_square))