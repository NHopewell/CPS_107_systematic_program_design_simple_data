...
(define B2 (make-ball 100 100 4 5))
(define B3 (make-ball 200 400 2 2))

(check-expect (render-ball B1) (place-image BALL (ball-x B1) (ball-y B1) MTS))
(check-expect (render-ball B2) (place-image BALL (ball-x B2) (ball-y B2) MTS))
...
(check-expect (touch-left?    (make-ball (+ LEF  3) TOP -4 4)) true)
(check-expect (touch-left?    (make-ball (+ LEF  4) TOP 3 -5)) false)
(check-expect (touch-left?    (make-ball (+ LEF  5) TOP 3 -5)) false)
(check-expect (touch-left?    (make-ball (+ LEF  2) TOP -3 3)) true)
...
(check-expect (touch-right?    (make-ball (- RIG  3) TOP 4 4)) true)
(check-expect (touch-right?    (make-ball (- RIG  4) TOP 3 -5)) false)
(check-expect (touch-right?    (make-ball (- RIG  5) TOP 3 -5)) false)
(check-expect (touch-right?    (make-ball (- RIG  2) TOP 3 3)) true)
...
(check-expect (bounce-left (make-ball (+ LEF 2) (- BOT 3) -3 4))
              (make-ball (+ LEF 1) (- BOT 3) 3  4))
(check-expect (bounce-left (make-ball (+ LEF 4) (- BOT 6) -4 7))
              (make-ball (+ LEF 1) (- BOT 6) 4 7))
...
(check-expect (bounce-right (make-ball (- RIG 3) (- BOT 3) 4 4))
              (make-ball (- RIG 1) (- BOT 3) -4  4))
(check-expect (bounce-right (make-ball (- RIG 2) (- BOT 6) 2 7))
              (make-ball (- RIG 1) (- BOT 6) -2 7))
...
(check-expect (glide (make-ball 1 1 1 1))
              (make-ball 2 2 1 1))
(check-expect (glide (make-ball 5 5 -2 -3))
              (make-ball 3 2 -2 -3))
