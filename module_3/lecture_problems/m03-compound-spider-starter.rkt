...
(define-struct spider (y-position direction))
;; Spider is a (make-spider Number Numer)
;; interp. spider has a y-coordinate (distance from top of screen)
;;         spider has a direction its moving (1 = down, 2 = up)
;; CONSTRAINT: to be visible, must be in [TOP, BOT]
;; TOP and BOT above, and
(define MID (/ HEIGHT 2))
